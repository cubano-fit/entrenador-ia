// assets/js/training.js - VERSIÓN CORREGIDA
window.training = {
    contador: 0,
    ...
    obtenerDatosUsuario: function() {
        ...
        console.log('📊 Perfil cargado en training:', perfil);
        return perfil;
    },
    ...
    generarPlan: function() {
        ...
        if (!datos) {
            alert('❌ Completa tu perfil primero (ve a Perfil y guarda tus datos)');
            return;
        }
    ...
    generarPlanSemanalPorDia: function(dia, datos) {
        ...
        console.log('🎯 Generando plan semanal con:', { sexo, nivel, objetivo, equipo });
        ...
        diaInfo.musculos.forEach(musculo => {
            ...
            console.log('🔍 Buscando ejercicios para:', categoria, 'con equipo:', equipo);
    ...
    generarPlanPorMusculo: function(musculo, datos) {
        ...
        console.log('🎯 Generando plan por músculo con:', { musculo, sexo, nivel, objetivo, equipo });
